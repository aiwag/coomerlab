...
//       case 'low': return <WifiOff size={14} className="text-red-400" />;
//       case 'medium': return <WifiLow size={14} className="text-yellow-400" />;
//       case 'high': return <WifiHigh size={14} className="text-green-400" />;
//       default: return <Wifi size={14} />;
//     }
//   };

//   return (
//     <div className="bg-neutral-800 text-white px-3 py-2 flex items-center justify-between text-xs border-b border-neutral-700">
...
//         >
//           {sidebarVisible ? (sidebarCollapsed ? <ChevronRight size={16} /> : <ChevronLeft size={16} />) : <ChevronRight size={16} />}
//         </button>
...
//           <div className="flex items-center gap-1">
//             {getBandwidthIcon()}
//             <span>{bandwidthMode}</span>
//           </div>
//           <div className="flex items-center gap-1">
//             <Wifi size={14} className={latency < 30 ? "text-green-400" : latency < 60 ? "text-yellow-400" : "text-red-400"} />
...
//               className={`px-2 py-1 rounded text-xs flex items-center gap-1 ${bandwidthMode === mode
...
//             className={`px-2 py-1 rounded text-xs flex items-center gap-1 ${gridMode === 'professional'
//                 ? "bg-cyan-600 text-white"
//                 : "text-neutral-300 hover:bg-neutral-600"
//               }`}
...
//             className={`px-2 py-1 rounded text-xs flex items-center gap-1 ${autoMode
//                 ? "bg-cyan-600 text-white"
//                 : "text-neutral-300 hover:bg-neutral-600"
//               }`}
//             title="Auto Mode"
...
//                   className={`px-2 py-1 rounded text-xs ${gridSize === size
//                       ? "bg-cyan-600 text-white"
//                       : "text-neutral-300 hover:bg-neutral-600"
//                     }`}
...
//           className={`px-2 py-1 rounded text-xs flex items-center gap-1 ${fullViewMode !== null
//               ? "bg-cyan-600 text-white"
//               : "text-neutral-300 hover:bg-neutral-600"
//             }`}
//           title="Full View Mode"
//         >
//           {fullViewMode !== null ? <Minimize2 size={12} /> : <Maximize2 size={12} />}
//           <span>Full</span>
//         </button>
...
//   return (
//     <div className={`bg-neutral-800 border-r border-neutral-700 transition-all duration-300 flex flex-col ${collapsed ? 'w-12' : 'w-64'
//       } overflow-hidden`}>
...
//         <>
//           <div className="p-2 border-b border-neutral-700 flex items-center justify-between">
//             <Database size={14} className="text-neutral-400" title="Data saved locally" />
//             <Layout size={14} className="text-neutral-400" title="View arrangement saved" />
//             <button
...
//                   className="flex-1 bg-neutral-700 text-white px-2 py-1 rounded text-xs focus:outline-none focus:ring-1 focus:ring-cyan-500"
//                 />
//                 <button
...
//               <div
//                 key={stream.url}
//                 className="bg-neutral-700 rounded-lg p-2 hover:bg-neutral-600 transition-colors cursor-pointer"
...
//                     />
//                     <div className={`absolute bottom-0 right-0 w-2 h-2 rounded-full ${stream.isPlaying ? "bg-green-500" : "bg-red-500"}`} />
//                   </div>
...
//   return (
//     <div
//       className="relative w-24 h-16 rounded overflow-hidden cursor-pointer hover:ring-2 hover:ring-cyan-500 transition-all flex-shrink-0"
...
//       </div>
//       <div className={`absolute top-1 right-1 w-2 h-2 rounded-full ${isPlaying ? "bg-green-500" : "bg-red-500"}`} />
//     </div>
//   );
// }
...
// }) {
//   return (
//     <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-2 flex justify-between items-center opacity-0 hover:opacity-100 transition-opacity">
//       <div className="flex gap-2">
//         <button
...
//         >
//           {isFavorite ? <Star size={14} className="fill-yellow-400 text-yellow-400" /> : <Star size={14} />}
//         </button>
//       </div>
...
//       <div
//         {...dragHandleProps}
//         className={`absolute top-1 right-1 bg-cyan-600 text-white text-xs font-semibold px-2 py-0.5 rounded-l select-none z-0 flex items-center gap-1 ${isDragging ? "opacity-80" : "opacity-100"
//           }`}
...
//         <>
//           {/* Top Stats Bar */}
//           <div className="absolute top-0 left-0 right-0 bg-gradient-to-b from-black/80 to-transparent p-2 z-0">
...
//           <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-2 z-0">
//             <div className="flex items-center justify-between text-white text-xs">
//               <div className="flex items-center gap-2">
...
//         <div className="absolute top-1 left-1 bg-black/60 text-white text-xs px-2 py-0.5 rounded z-10 flex items-center gap-1">
//           <div className={`w-2 h-2 rounded-full ${isPlaying ? "bg-green-500" : "bg-red-500"}`} />
...
//       {isLoading && (
//         <div className="absolute top-0 left-0 w-full h-1 bg-neutral-700 z-0">
//           <div
...
//     saveSettings();
//   }, [gridSize, sidebarVisible, sidebarCollapsed, bandwidthMode, autoMode, fullViewMode, showOffline, gridMode, dbService]);
...
//             {/* Minimized Streams */}
//             <div className="h-20 bg-neutral-800 border-t border-neutral-700 p-2 flex gap-2 overflow-x-auto custom-scrollbar-horizontal">
...
//                 >
//                   {streamUrls.map((url, index) => (
//                     <div key={url} id={`stream-${index}`} className="h-full min-h-0">
//                       <SortableWebview
//                         id={url}
//                         url={url}
//                         index={index}
...
//               ) : (
//                 <div
//                   className={`h-full p-2 grid gap-2 custom-scrollbar`}
//                   style={{
//                     gridTemplateColumns: `repeat(${gridLayout.columns}, minmax(0, 1fr))`,
...
//   return (
//     <div className="w-80 bg-neutral-800 border-r border-neutral-700 flex flex-col h-full">
//       {/* Header */}
...
//             className="w-full bg-neutral-700 text-white pl-10 pr-4 py-2 rounded text-sm focus:outline-none focus:ring-1 focus:ring-cyan-500"
//             value={searchTerm}
...
//             {connectionStatus === 'limited' && <Wifi size={14} className="text-yellow-500" />}
//             {connectionStatus === 'disconnected' && <WifiOff size={14} className="text-red-500" />}
...
//               className={`px-2 py-1 rounded text-xs transition-all ${refreshInterval === 3 && !isAnimatedMode ? 'bg-cyan-600 text-white' : 'text-gray-400 hover:text-white'}`}
//             >
//               3s
//             </button>
//             <button
//               onClick={() => handleIntervalChange(10)}
//               className={`px-2 py-1 rounded text-xs transition-all ${refreshInterval === 10 && !isAnimatedMode ? 'bg-cyan-600 text-white' : 'text-gray-400 hover:text-white'}`}
//             >
//               10s
//             </button>
//             <button
//               onClick={() => handleIntervalChange(30)}
//               className={`px-2 py-1 rounded text-xs transition-all ${refreshInterval === 30 && !isAnimatedMode ? 'bg-cyan-600 text-white' : 'text-gray-400 hover:text-white'}`}
//             >
//               30s
//             </button>
//             <button
//               onClick={toggleAnimatedMode}
//               className={`px-2 py-1 rounded text-xs transition-all flex items-center gap-1 ${isAnimatedMode ? 'bg-cyan-600 text-white' : 'text-gray-400 hover:text-white'}`}
//             >
//               <Zap size={12} />
//               <span>Live</span>
//             </button>
...
//         {/* Error Message */}
//         {error && (
//           <div className="p-2 bg-red-900 bg-opacity-30 border border-red-800 rounded flex items-center gap-2">
...
//                 className={`px-2 py-1 rounded text-xs transition-all ${filters.gender === gender
//                     ? 'bg-cyan-600 text-white'
...
//                 <div className="flex-1 min-w-0">
//                   <div className="flex items-center justify-between">
//                     <h4 className="text-sm font-medium text-white truncate">{streamer.username}</h4>
//                     <button
//                       onClick={(e) => {
//                         e.stopPropagation();
...
//       <div
//         {...dragHandleProps}
//         className={`absolute top-1 right-1 bg-cyan-600 text-white text-xs font-semibold px-2 py-0.5 rounded-l select-none z-10 flex items-center gap-1 ${isDragging ? "opacity-80" : "opacity-100"
//           }`}
//         title="Drag to reorder"
//       >
//         <GripVertical size={12} />
...
//             <div
//               key={notification.id}
//               className={`p-3 rounded-lg shadow-lg max-w-sm ${notification.type === 'error' ? 'bg-red-900 bg-opacity-80' :
...
//     if (width > 320) count += Math.floor((width - 320) / 50);
...
//       className="bg-neutral-800 border-r border-neutral-700 flex flex-col h-full relative"
...
//     saveSettings();
//   }, [gridSize, sidebarVisible, sidebarCollapsed, bandwidthMode, autoMode, fullViewMode, showOffline, gridMode, showBrowser, browserWidth, dbService]);
